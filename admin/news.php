                        ...
                        <div class="w-100">
                            ...
                            <div class="card mt-3">
                                <div class="card-header">
                                    <h3 class="card-title">ข้อมูลข่าว &amp; การปรับแต่ง <a class="btn btn-outline-primary btn-sm " href="news-add.php" role="button"> + </a></h3>
                                </div>
                                                ...
                                                <table id="example2" class="table table-bordered table-hover dataTable dtr-inline" aria-describedby="example2_info">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending">รายละเอียด</th>
                                                            ...
                                                            <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="CSS grade: activate to sort column ascending">วันที่</th>
                                                    ...
                                                    <?php while ($row = $result->fetch_assoc()) : ?>
                                                        <tr class="odd">
                                                            ...
                                                            <td><img src="../<?php echo $row['img'] ?>" class="img-fluid news-a" alt=""></td>
                                                            ...
                                                            <td class="d-flex">
                                                                <div class="m-auto">
                                                                        ...
                                                                        <a class="btn btn-primary btn-sm " href="./news-edit.php?id=<?php echo $row['id']; ?>&table=<?php echo $table; ?>" role="button">edit</a>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    <?php endwhile ?>
